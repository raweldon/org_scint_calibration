...
def save_to_df(results):
    ...
    df.to_pickle('cpvert_test_gamma_cal_res.p')
    print '\n\ndata was save to cpvert_test_gamma_cal_res.p'
...
def main(bvert_11, cpvert_11, bvert_4, cpvert_4, save_arrays):
    ...
    if os.path.isfile('cpvert_test_gamma_cal_res.p'):
        data = pd.read_pickle('cpvert_test_gamma_cal_res.p')  
